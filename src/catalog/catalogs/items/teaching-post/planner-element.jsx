...
export default {
    ...
    render3D: function (element, layer, scene) {
        let makeChair = (altitude) => {
            ...
            let geometry50 = new Three.ExtrudeGeometry(
                roundedRectShape,
                extrudeSettings
            );
            ...
            let geometry22 = new Three.ExtrudeGeometry(
                roundedRectShape2,
                extrudeSettings2
            );
        ...
        let p1 = new Three.Mesh(
            new Three.BoxGeometry(0.06, 0.06, cattedraZ),
            materialTexture
        );
        ...
        let plane = new Three.Mesh(
            new Three.BoxGeometry(cattedraX, cattedraY, 0.04),
            boxMaterials
        );
        ...
        let backPlane = new Three.Mesh(
            new Three.BoxGeometry(cattedraX, cattedraY / 2 - 0.1, 0.04),
            materialTexture
        );
        ...
        let downPlane = new Three.Mesh(
            new Three.BoxGeometry(cattedraX, cattedraY / 20, 0.04),
            materialTexture
        );
        ...
        let leftPlane = new Three.Mesh(
            new Three.BoxGeometry(cattedraY, cattedraY / 2 - 0.1, 0.04),
            materialTexture
        );
        ...
        let drawer = new Three.Mesh(
            new Three.BoxGeometry(cattedraX / 4, cattedraY, 0.4),
            materialTexture
        );
        ...
        let boundingBoxDeskAndChair = new Three.Box3().setFromObject(
            deskAndChair
        );

        let deltaZDeskAndChair = Math.abs(
