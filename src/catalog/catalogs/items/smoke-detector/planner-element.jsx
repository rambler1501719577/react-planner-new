...
function makeObjectMaxLOD() {
    ...
    let BaseGeometry1 = new Three.CylinderGeometry(0.55, 0.55, 0.25, 32, 32);
    let base_p1 = new Three.Mesh(BaseGeometry1, grey);
    detector.add(base_p1);

    let BaseGeometry2 = new Three.CylinderGeometry(0.65, 0.65, 0.1, 32, 32);
    let base_p2 = new Three.Mesh(BaseGeometry2, grey);
    base_p2.position.y += 0.125;
    base_p1.add(base_p2);

    let BaseGeometry3 = new Three.CylinderGeometry(0.55, 0.65, 0.1, 32, 32);
    let base_p3 = new Three.Mesh(BaseGeometry3, grey);
    base_p3.position.y += 0.22;
    base_p1.add(base_p3);

    let BaseGeometry4 = new Three.CylinderGeometry(0.65, 0.65, 0.1, 32, 32);
    ...
    for (let i = 0; i < Math.PI * 4; i += (4 * Math.PI) / 3) {
        ...
        let geometry2 = new Three.TorusGeometry(
            0.35,
            0.025,
            32,
            100,
...
function makeObjectMinLOD() {
    ...
    let BaseGeometry1 = new Three.CylinderGeometry(0.55, 0.55, 0.25, 8, 8);
    let base_p1 = new Three.Mesh(BaseGeometry1, grey);
    detector.add(base_p1);

    let BaseGeometry2 = new Three.CylinderGeometry(0.65, 0.65, 0.1, 8, 8);
    let base_p2 = new Three.Mesh(BaseGeometry2, grey);
    base_p2.position.y += 0.125;
    base_p1.add(base_p2);

    let BaseGeometry3 = new Three.CylinderGeometry(0.55, 0.65, 0.1, 8, 8);
    let base_p3 = new Three.Mesh(BaseGeometry3, grey);
    base_p3.position.y += 0.22;
    base_p1.add(base_p3);

    let BaseGeometry4 = new Three.CylinderGeometry(0.65, 0.65, 0.1, 8, 8);
    let base_p4 = new Three.Mesh(BaseGeometry4, grey);
    base_p4.position.y += -0.125;
    base_p1.add(base_p4);
