...
export default {
    ...
    render3D: function (element, layer, scene) {
        ...
        let tableGeometry = new Three.ExtrudeGeometry(
        ...
        let baseVerticalGeometry = new Three.CylinderGeometry(
            0.08,
            0.08,
            0.6,
            32
        );
        let unionGeometry = new Three.CylinderGeometry(0.08, 0.08, 0.2, 32);
        let footGeometry = new Three.CylinderGeometry(0.06, 0.06, 0.025, 32);
        let closureGeometry = new Three.CylinderGeometry(0.08, 0.08, 0.02, 32);
        ...
        let baseCurvedGeometry = new Three.TorusGeometry(
            0.5,
            0.08,
            32,
            32,
        ...
        let stairGeometryPiece1 = new Three.ExtrudeGeometry(
        ...
        let stairGeometryPiece2 = new Three.ExtrudeGeometry(
