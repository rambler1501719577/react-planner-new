...
function makeObjectMaxLOD() {
    ...
    let geometry0 = new Three.ExtrudeGeometry(
        roundedRectShape,
        extrudeSettings
    );
    ...
    let geometry1d = new Three.BoxGeometry(0.35, 0.6, 0.1);
    ...
    let geometry1f = new Three.BoxGeometry(0.15, 0.15, 0.01);
    ...
    let stopperGeometry3 = new Three.CylinderGeometry(
        0.01,
        0.01,
        0.065,
        16,
    ...
    let cylinderGeometry3 = new Three.CylinderGeometry(
        0.015,
        0.015,
        0.1,
        16,
    ...
    let cylinderGeometry4 = new Three.CylinderGeometry(
        0.018,
        0.018,
        0.22,
        16,
    ...
    let cylinderGeometry5 = new Three.CylinderGeometry(
        0.018,
        0.018,
        0.1,
        16,
