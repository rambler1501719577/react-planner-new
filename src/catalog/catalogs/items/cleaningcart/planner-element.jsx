...
function makeObjectMaxLOD() {
    //base
    let cleaning_cart = new Three.Mesh(
    ...
    for (cz = -0.76; cz <= -0.1; cz += 0.25) {
        ...
        //long side
        let longSideGeometry = new Three.BoxGeometry(0.02, 0.2, 0.75);
    ...
    let wasteSupport_1 = new Three.Mesh(
    ...
    let wasteSupport_3 = new Three.Mesh(
        new Three.BoxGeometry(0.05, 0.65, 0.05),
        grey
    );
    ...
    let wasteSupportDown_1 = new Three.Mesh(
        new Three.BoxGeometry(0.5, 0.05, 0.05),
        grey
    );
    ...
    let wasteSupportDown_3 = new Three.Mesh(
        new Three.BoxGeometry(0.05, 0.65, 0.05),
        grey
    );
    ...
    for (let sty = -0.3; sty <= 0.3; sty += 0.6) {
        ...
        let bucketTop_1 = new Three.Mesh(
        ...
        let bucketTop_2 = new Three.Mesh(
        ...
        let bucketTop_3 = new Three.Mesh(
            new Three.BoxGeometry(0.2, 0.15, 0.02),
            color1
        );
        ...
        let bucketTop_4 = new Three.Mesh(
        ...
        let bucketTop_5 = new Three.Mesh(
            new Three.BoxGeometry(0.15, 0.3, 0.02),
            color1
        );
    ...
    for (let sty = -0.3; sty <= 0.3; sty += 0.6) {
        ...
        let bucketTop2_p1 = new Three.Mesh(
            new Three.BoxGeometry(0.2, 0.3, 0.05),
            color2
        );
        ...
        let bucketTop2_p2 = new Three.Mesh(
            new Three.BoxGeometry(0.2, 0.15, 0.02),
            color2
        );
        ...
        let bucketTop2_p3 = new Three.Mesh(
            new Three.BoxGeometry(0.2, 0.15, 0.02),
            color2
        );
        ...
        let bucketTop2_p4 = new Three.Mesh(
            new Three.BoxGeometry(0.15, 0.3, 0.02),
            color2
        );
        ...
        let bucketTop2_p5 = new Three.Mesh(
            new Three.BoxGeometry(0.15, 0.3, 0.02),
            color2
        );
    ...
    for (let sdy = -0.3; sdy <= 0.3; sdy += 0.6) {
        ...
        let bucketTop3_p1 = new Three.Mesh(
        ...
        let bucketTop3_p2 = new Three.Mesh(
        ...
        let bucketTop3_p3 = new Three.Mesh(
            new Three.BoxGeometry(0.4, 0.25, 0.02),
            color
        );
        ...
        let bucketTop3_p4 = new Three.Mesh(
        ...
        let bucketTop3_p5 = new Three.Mesh(
            new Three.BoxGeometry(0.25, 0.3, 0.02),
            color
        );
    ...
    for (let scy = -0.45; scy <= 0.55; scy += 0.9) {
        ...
        let broom_handle = new Three.Mesh(
