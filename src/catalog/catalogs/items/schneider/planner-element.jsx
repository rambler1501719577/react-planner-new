...
function makeObjectMaxLOD() {
    ...
    let gridVerticalElemGeometry = new Three.BoxGeometry(
        gridThickness / 2,
        filterHeight,
        filterDepth
    );
    let gridHorizontalElemGeometry = new Three.BoxGeometry(
        filterWidth,
        gridThickness,
        filterDepth
    );
    ...
    for (let i = 0; i < 52; i += 7.4) {
        let gridHorizontalElem = new Three.Mesh(
    ...
    let panelSideElemRight = new Three.Mesh(
    ...
    let panelSideElemBack = new Three.Mesh(
    ...
    let boxElemGeometry = new Three.BoxGeometry(
        width / 3,
        height / 3,
        depth / 8
    );
    ...
    let panelSideFrontElemGeometry = new Three.BoxGeometry(
        width / 3,
        height,
        5
    );
    let panelSideElemFront_P1 = new Three.Mesh(
    ...
    let panelSideElemFront_P2 = new Three.Mesh(
        panelSideFrontElemGeometry,
        boxMaterials2
    );
    ...
    let panelSideElemFront_P3 = new Three.Mesh(
        panelSideFrontElemGeometry,
        boxMaterials2
    );
    ...
    let panelSideElemFooter = new Three.Mesh(
