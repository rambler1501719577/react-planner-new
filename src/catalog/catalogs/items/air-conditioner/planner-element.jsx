...
function makeObjectMaxLOD() {
    ...
    let bodyGeometry = new Three.ExtrudeGeometry(
        roundedRectShape,
        extrudeSettings
    );
    ...
    for (let i = -0.3; i > -0.36; i -= 0.005) {
        let gridHorizontalGeometry = new Three.BoxGeometry(0.001, 0.025, 0.705);
    ...
    for (let k = 0.15; k < 0.87; k += 0.05) {
        let gridVerticalGeometry = new Three.BoxGeometry(0.079, 0.025, 0.005);
    ...
    let frontCoverGeometry = new Three.ExtrudeGeometry(
        roundedRectShape2,
        extrudeSettings2
    );
    ...
    let flapSupportGeometry = new Three.ExtrudeGeometry(
        roundedRectShape3,
        extrudeSettings3
    );
    ...
    points2.push(new Three.Vector3(0.5, 0));
    points2.push(new Three.Vector3(0.5, 0.8));
    points2.push(new Three.Vector3(0.5, 0.8));

    let flapGeometry = new Three.LatheGeometry(
        points2,
        200,
        Math.PI / 2,
        Math.PI / 16
