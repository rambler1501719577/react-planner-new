...
function makeMonitor(newDepth) {
    ...
    let cubeGeometryBase3 = new Three.BoxGeometry(0.4, 0.4, 0.05);
...
function makeObjectMaxLOD(newWidthA, newWidthB, newHeight, newDepth) {
    ...
    if (newWidthA < newWidthB) {
        ...
        rectShape2.lineTo(
            newWidthA + (newWidthB / 2 - newWidthA / 2),
            newDepth
        );
        ...
        hole.moveTo(
            newWidthA / 2 - newWidthB / 2 - newWidthA / 20,
            newDepth / 20
        );
        hole.lineTo(
    ...
    let geometry5 = new Three.BoxGeometry(
        newWidthA,
        newDepth / 20,
        1.6 * newHeight
    );
    ...
    if (newWidthA < newWidthB) c = newWidthB / 2 - newWidthA / 2;
    else if (newWidthA > newWidthB) c = newWidthA / 2 - newWidthB / 2;
    ...
    for (let i = index + incrPosition; i < lastPosition; i += incrPosition) {
        let geometry8 = new Three.BoxGeometry(
            newDepth,
            newDepth / 20,
            1.55 * newHeight
        );
    ...
    render2D: function (element, layer, scene) {
        ...
        return (
            <g transform={`translate(${-newWidthA / 2},${-newDepth / 2})`}>
                <path
                    key="1"
                    d={`M ${newWidthA / 2 - newWidthB / 2} 0 l ${
                        -newWidthA / 2 + newWidthB / 2
                    } ${newDepth} l ${newWidthA} 0 l ${
                        -newWidthA / 2 + newWidthB / 2
                    }${-newDepth} l ${-newWidthB} 0`}
                    stroke="red"
                ...
                <text
                    ...
                    x="0"
                    y="0"
                    transform={`translate(${newWidthA / 2}, ${
                        newDepth / 2
