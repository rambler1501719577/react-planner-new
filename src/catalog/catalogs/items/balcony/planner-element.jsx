...
function makeObject(newWidth, newHeight, newDepth) {
    ...
    //base
    let cubeGeometryBase = new Three.BoxGeometry(
        newWidth,
        newHeight / 10,
        newDepth
    );
    ...
    let cubeGeometryBase2 = new Three.BoxGeometry(
        newWidth,
        newHeight / 10,
        newDepth
    );
    ...
    let cubeGeometryBase3 = new Three.BoxGeometry(
        newDepth,
        newHeight / 10,
        newDepth
    );
    ...
    let cubeGeometryBase5 = new Three.BoxGeometry(
    ...
    let cubeGeometryBase6 = new Three.BoxGeometry(
        newDepth,
        newHeight / 5,
        newDepth / 10
    );
