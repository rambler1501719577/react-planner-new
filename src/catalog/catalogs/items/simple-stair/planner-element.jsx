...
export default {
    ...
    render3D: function (element, layer, scene) {
        ...
        let newAltitude = convert(
            element.properties.get("altitude").get("length")
        )
        ...
        let stairShapeProfileGeometry = new Three.ShapeGeometry(
            stairShapeProfile
        );
        ...
        let stairClosure1 = new Three.Mesh(
        ...
        let closure3Width = 0;
        let closure3Depth = 0;
        let stairClosure3Geometry = new Three.PlaneGeometry(
            stepWidth,
            stepDepth
        );
