...
function makeObjectMaxLOD() {
    ...
    //central axis
    let centralAxis = new Three.Mesh(
    ...
    //up door
    let upDoor_p1 = new Three.Mesh(
        new Three.BoxGeometry(0.05, 0.77, 0.9),
        blue
    );
