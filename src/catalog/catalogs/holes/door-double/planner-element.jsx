...
function makeDoor(width, height, thickness) {
    ...
    let LongDoorGeometry = new Three.BoxGeometry(
        0.75 * width,
        height,
        thickness
    );
...
export default {
    ...
    render2D: function (element, layer, scene) {
        ...
        let arcPath = `M${0},${0}  A${holeWidth / 4},${holeWidth / 4} 0 0,1 ${
            holeWidth / 4
        },${holeWidth / 4}`;
        let arcPath2 = `M${0},${0}  A${holeWidth / 2 + holeWidth / 4},${
            holeWidth / 2 + holeWidth / 4
        } 0 0,0 ${holeWidth / 2 + holeWidth / 4},${
            holeWidth / 2 + holeWidth / 4
        }`;
