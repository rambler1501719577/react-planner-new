...
function makeDoor(handleSide) {
    ...
    if (handleSide === "right") door.position.set(-1, 0, 0);
    else door.position.set(0, 0, 0);
    slidingDoor.add(door);

    let doorGeometry = new Three.BoxGeometry(1, 2, 0.05);
    let door2 = new Three.Mesh(doorGeometry, grey);
    if (handleSide === "right") door2.position.set(1.5, 1, 0.065);
    else door2.position.set(-0.5, 1, 0.065);
    door.add(door2);
    ...
    let HandleGeometry1 = new Three.CylinderGeometry(
        0.051,
        0.051,
        0.0625,
        80,
...
export default {
    ...
    render2D: function (element, layer, scene) {
        ...
        let holeStyle = element.selected
            ? STYLE_HOLE_SELECTED
            : STYLE_HOLE_BASE;
        let holeStyle2 = element.selected
            ? STYLE_HOLE_SELECTED
            : STYLE_HOLE_BASE2;
